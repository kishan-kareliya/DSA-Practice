...
// LEETCODE-QUESTION-LINK: https://leetcode.com/problems/kids-with-the-greatest-number-of-candies/description/
...
public class KidsWiththeGreatestNumberofCandies {
    ...
    public static ArrayList<Boolean> kidsWithCandies(int[] candies, int extraCandies) {
        ...
        for(int i=0;i<candies.length;i++){
            answer.add(max(candies,(candies[i]+extraCandies)));
        }
        return answer;
    }
    public static boolean max(int[] arr,int value){
        int max = value;
